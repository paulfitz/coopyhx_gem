...
int Coopy_obj::main( ){
	HX_STACK_FRAME("coopy.Coopy","main",0xb7eb371d,"coopy.Coopy.main","coopy/Coopy.hx",330,0x36f081f5)
	HX_STACK_LINE(330)
	return (int)0;
}
...
{
		HX_STACK_FRAME("coopy.Coopy","show",0xbbe7d3e1,"coopy.Coopy.show","coopy/Coopy.hx",334,0x36f081f5)
		HX_STACK_ARG(t,"t")
		HX_STACK_LINE(335)
		...
		HX_STACK_LINE(345)
		::haxe::Log_obj::trace(txt,hx::SourceInfo(HX_CSTRING("Coopy.hx"),345,HX_CSTRING("coopy.Coopy"),HX_CSTRING("show")));
	}
return null();
}
...
Dynamic Coopy_obj::jsonify( ::coopy::Table t){
	HX_STACK_FRAME("coopy.Coopy","jsonify",0x653ff470,"coopy.Coopy.jsonify","coopy/Coopy.hx",349,0x36f081f5)
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(350)
