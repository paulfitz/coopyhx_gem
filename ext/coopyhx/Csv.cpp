...
{
HX_STACK_PUSH("Csv::new","coopy/Csv.hx",11);
{
	HX_STACK_LINE(12)
	this->cursor = (int)0;
	HX_STACK_LINE(13)
...
::String Csv_obj::parseSingleCell( ::String txt){
	HX_STACK_PUSH("Csv::parseSingleCell","coopy/Csv.hx",157);
	HX_STACK_THIS(this);
...
::String Csv_obj::parseCell( ::String txt){
	HX_STACK_PUSH("Csv::parseCell","coopy/Csv.hx",92);
	HX_STACK_THIS(this);
	HX_STACK_ARG(txt,"txt");
	HX_STACK_LINE(93)
	if (((txt == null()))){
...
Array< Array< ::String > > Csv_obj::parseTable( ::String txt){
	HX_STACK_PUSH("Csv::parseTable","coopy/Csv.hx",74);
	HX_STACK_THIS(this);
	HX_STACK_ARG(txt,"txt");
	HX_STACK_LINE(75)
	this->cursor = (int)0;
	...
	HX_STACK_LINE(78)
	Array< Array< ::String > > result = Array_obj< Array< ::String > >::__new();		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(79)
...
::String Csv_obj::renderTable( ::coopy::Table t){
	HX_STACK_PUSH("Csv::renderTable","coopy/Csv.hx",16);
	HX_STACK_THIS(this);
	HX_STACK_ARG(t,"t");
	HX_STACK_LINE(17)
	::String result = HX_CSTRING("");		HX_STACK_VAR(result,"result");
