...
class HXCPP_CLASS_ATTRIBUTES  Alignment_obj : public hx::Object{
	...
	public:
		...
		virtual Void addIndexColumns( ::coopy::Unit unit);
		Dynamic addIndexColumns_dyn();

		virtual Array< ::Dynamic > getIndexColumns( );
		Dynamic getIndexColumns_dyn();
