...
{
HX_STACK_PUSH("SparseSheet::new","coopy/SparseSheet.hx",11);
{
	HX_STACK_LINE(11)
	this->h = this->w = (int)0;
}
...
{
		HX_STACK_PUSH("SparseSheet::set","coopy/SparseSheet.hx",34);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_ARG(y,"y");
...
Dynamic SparseSheet_obj::get( int x,int y){
	HX_STACK_PUSH("SparseSheet::get","coopy/SparseSheet.hx",26);
	HX_STACK_THIS(this);
	HX_STACK_ARG(x,"x");
	HX_STACK_ARG(y,"y");
	HX_STACK_LINE(27)
...
{
		HX_STACK_PUSH("SparseSheet::nonDestructiveResize","coopy/SparseSheet.hx",20);
		HX_STACK_THIS(this);
		HX_STACK_ARG(w,"w");
		HX_STACK_ARG(h,"h");
...
{
		HX_STACK_PUSH("SparseSheet::resize","coopy/SparseSheet.hx",15);
		HX_STACK_THIS(this);
		HX_STACK_ARG(w,"w");
		HX_STACK_ARG(h,"h");
		HX_STACK_ARG(zero,"zero");
