...
{
HX_STACK_PUSH("Viterbi::new","coopy/Viterbi.hx",17);
{
	HX_STACK_LINE(18)
	this->K = this->T = (int)0;
	HX_STACK_LINE(19)
...
Float Viterbi_obj::getCost( ){
	HX_STACK_PUSH("Viterbi::getCost","coopy/Viterbi.hx",151);
	HX_STACK_THIS(this);
	HX_STACK_LINE(152)
	this->calculatePath();
	HX_STACK_LINE(153)
...
int Viterbi_obj::get( int i){
	HX_STACK_PUSH("Viterbi::get","coopy/Viterbi.hx",146);
	HX_STACK_THIS(this);
	HX_STACK_ARG(i,"i");
	HX_STACK_LINE(147)
	this->calculatePath();
...
int Viterbi_obj::length( ){
	HX_STACK_PUSH("Viterbi::length","coopy/Viterbi.hx",139);
	HX_STACK_THIS(this);
	HX_STACK_LINE(140)
	if (((this->index > (int)0))){
		HX_STACK_LINE(140)
...
::String Viterbi_obj::toString( ){
	HX_STACK_PUSH("Viterbi::toString","coopy/Viterbi.hx",124);
	HX_STACK_THIS(this);
	HX_STACK_LINE(125)
	this->calculatePath();
	HX_STACK_LINE(126)
...
{
		HX_STACK_PUSH("Viterbi::calculatePath","coopy/Viterbi.hx",94);
		HX_STACK_THIS(this);
		HX_STACK_LINE(95)
		if ((this->path_valid)){
			HX_STACK_LINE(95)
...
{
		HX_STACK_PUSH("Viterbi::beginTransitions","coopy/Viterbi.hx",89);
		HX_STACK_THIS(this);
		HX_STACK_LINE(90)
...
{
		HX_STACK_PUSH("Viterbi::endTransitions","coopy/Viterbi.hx",84);
		HX_STACK_THIS(this);
		HX_STACK_LINE(85)
		this->path_valid = false;
		HX_STACK_LINE(86)
...
{
		HX_STACK_PUSH("Viterbi::addTransition","coopy/Viterbi.hx",45);
		HX_STACK_THIS(this);
		HX_STACK_ARG(s0,"s0");
		HX_STACK_ARG(s1,"s1");
		HX_STACK_ARG(c,"c");
...
{
		HX_STACK_PUSH("Viterbi::assertMode","coopy/Viterbi.hx",40);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Viterbi::setSize","coopy/Viterbi.hx",32);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Viterbi::reset","coopy/Viterbi.hx",25);
		HX_STACK_THIS(this);
		HX_STACK_LINE(26)
		this->index = (int)0;
		HX_STACK_LINE(27)
