...
{
HX_STACK_PUSH("Compare::new","coopy/Compare.hx",7);
{
}
;
	return null();
...
bool Compare_obj::comparePrimitive( ::coopy::Workspace ws){
	HX_STACK_PUSH("Compare::comparePrimitive","coopy/Compare.hx",79);
	HX_STACK_THIS(this);
	HX_STACK_ARG(ws,"ws");
	HX_STACK_LINE(81)
...
bool Compare_obj::compareTable( ::coopy::Workspace ws){
	HX_STACK_PUSH("Compare::compareTable","coopy/Compare.hx",40);
	HX_STACK_THIS(this);
	HX_STACK_ARG(ws,"ws");
	HX_STACK_LINE(41)
...
bool Compare_obj::compareStructured( ::coopy::Workspace ws){
	HX_STACK_PUSH("Compare::compareStructured","coopy/Compare.hx",29);
	HX_STACK_THIS(this);
	HX_STACK_ARG(ws,"ws");
	HX_STACK_LINE(30)
...
bool Compare_obj::compare( ::coopy::ViewedDatum parent,::coopy::ViewedDatum local,::coopy::ViewedDatum remote,::coopy::Report report){
	HX_STACK_PUSH("Compare::compare","coopy/Compare.hx",12);
	HX_STACK_THIS(this);
