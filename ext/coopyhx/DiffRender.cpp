...
{
		HX_STACK_FRAME("coopy.DiffRender","render",0x9579ba27,"coopy.DiffRender.render","coopy/DiffRender.hx",200,0xe6f800c0)
		HX_STACK_THIS(this)
...
::String DiffRender_obj::sampleCss( ){
	HX_STACK_FRAME("coopy.DiffRender","sampleCss",0xf7e1db88,"coopy.DiffRender.sampleCss","coopy/DiffRender.hx",243,0xe6f800c0)
	HX_STACK_THIS(this)
	HX_STACK_LINE(243)
...
{
		HX_STACK_FRAME("coopy.DiffRender","completeHtml",0xe25dd455,"coopy.DiffRender.completeHtml","coopy/DiffRender.hx",302,0xe6f800c0)
		HX_STACK_THIS(this)
		HX_STACK_LINE(303)
						...
						if (((vrow.indexOf(HX_CSTRING("->"),null()) >= (int)0))){
							...
							if ((!(removed_column))){
								...
								if (((cell->value.indexOf(part,null()) >= (int)0))){
									...
									HX_STACK_LINE(143)
									cell->pretty_value = pretty_tokens->join(::String::fromCharCode((int)8594));
									HX_STACK_LINE(144)
...
::String DiffRender_obj::markSpaces( ::String sl,::String sr){
	HX_STACK_FRAME("coopy.DiffRender","markSpaces",0x2454e82b,"coopy.DiffRender.markSpaces","coopy/DiffRender.hx",154,0xe6f800c0)
	HX_STACK_ARG(sl,"sl")
	HX_STACK_ARG(sr,"sr")
	HX_STACK_LINE(155)
	if (((sl == sr))){
...
::coopy::CellInfo DiffRender_obj::renderCell( ::coopy::TableText tt,int x,int y){
	HX_STACK_FRAME("coopy.DiffRender","renderCell",0x6f15a769,"coopy.DiffRender.renderCell","coopy/DiffRender.hx",185,0xe6f800c0)
	HX_STACK_ARG(tt,"tt")
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
	HX_STACK_LINE(186)
